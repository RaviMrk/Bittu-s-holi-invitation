  ...
  return (
    <section id="message" className="relative py-24 px-4 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          {/* Top badge */}
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-cream-50 px-6 py-1.5 rounded-full border border-gold-400/30 shadow-sm">
            <span className="text-gold-500 font-display text-xs tracking-[0.15em] font-medium">
          ...
          {/* Decorative quotes */}
          <div className="absolute top-8 left-8 text-gold-400/20 text-7xl font-cursive select-none leading-none">
            &ldquo;
          </div>
          <div className="absolute bottom-8 right-8 text-gold-400/20 text-7xl font-cursive select-none leading-none rotate-180">
            &ldquo;
          </div>
          ...
          <motion.p
            ...
            className="text-royal-700/80 font-display text-xl md:text-2xl leading-relaxed mb-6 relative z-10 italic"
          >
          ...
          <motion.p
            ...
            className="text-gold-500 font-cursive text-2xl md:text-3xl relative z-10"
          >
            — ओजस, यशस्वी
          </motion.p>
        </motion.div>
